...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Olumide A." },
      { property: "og:title", content: "Olumide — Shopify CRO & Growth Specialist" },
      { property: "og:description", content: "Real Shopify audits and fixes that move conversion. $41,088 single-day result for a client." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Olumide — Shopify CRO & Growth Specialist" },
      { name: "twitter:description", content: "Real Shopify audits and fixes that move conversion." },
    ],
    links: [
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "Olumide Digital Solution",
          description:
            "Shopify CRO and growth specialist. Product page optimization, trust signals, mobile CRO, upsells, branding, SEO and speed for Shopify store owners.",
          ...
          hasOfferCatalog: {
            ...
            itemListElement: [
              ...
              "Upsell and Cross-Sell Structure",
              "Premium Branding Upgrade",
              "SEO Optimization",
              "Speed and UX Optimization",
              "Favicon and Visual Polish",
