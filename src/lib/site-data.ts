...
export const services = [
  {
    ...
    desc: "Rewrite copy, restructure layout, add scarcity and social proof so product pages convert.",
    brands: [
  ...
  },
  {
    ...
    desc: "Reviews, badges, guarantees, shipping and return clarity placed where buyers hesitate.",
    brands: [
  ...
  {
    title: "Upsell and Cross-Sell Structure",
  ...
  {
    title: "Favicon and Visual Polish",
...
export const packages = [
  {
    ...
    blurb: "I review your store and send a video plus written audit with exact fixes.",
    features: [
      "Full store walkthrough (video)",
      "Homepage, PDP and mobile review",
      "Trust and CRO issues flagged",
      "Speed and SEO snapshot",
      "Action list, prioritized by impact",
    ],
  },
  {
    name: "Growth Build", price: "From $700", popular: true,
    blurb: "I implement the audit. PDP, trust, mobile CRO, upsells and branding polish.",
    features: [
      "Product Page Optimization",
      "Trust Signal System",
      "Mobile CRO Optimization",
      "Upsell and Cross-Sell setup",
      "Speed and SEO baseline",
  ...
  },
  {
    ...
    features: [
      ...
      "Advanced CRO and A/B framework",
      "SEO, Favicon and Visual polish",
